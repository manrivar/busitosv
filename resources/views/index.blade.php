      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="index.html">
            <img src="/Landing/images/logob.png" alt="">
            <span>
              Busito SV
            </span>
          </a>
        ...
        <div class="col-md-6 offset-md-2">
          ...
          <div class="container layout_padding2">
            <div class="row">
              <div class="col-md-4">
                <div class="img_box">
                  <img src="/Landing/images/s-1.png" alt="">
                </div>
              ...
              <div class="col-md-4">
                <div class="img_box">
                  <img src="/Landing/images/s-2.png" alt="">
                </div>
                <div class="detail_box">
                  <h6>
                    Pet Hotel
              ...
              <div class="col-md-4">
                <div class="img_box">
                  <img src="/Landing/images/s-3.png" alt="">
                </div>
                <div class="detail_box">
                  <h6>
                    Emergency
